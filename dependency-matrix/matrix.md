...
---------- | ------- | ------- | -------------------
[jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) | [2.0.976-312](https://github.com/jenkins-x/jenkins-x-builders/releases/tag/v2.0.976-312) | **0.1.758**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
[jenkins-x/jx](https://github.com/jenkins-x/jx) | [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller);[github.com/jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow);[github.com/jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git);[github.com/jenkins-x/jenkins-x-builders](https://github.com/jenkins-x/jenkins-x-builders.git) | [2.0.976](https://github.com/jenkins-x/jx/releases/tag/v2.0.976) | **2.0.806**: [github.com/jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller)
[kubernetes-incubator/external-dns](https://github.com/kubernetes-incubator/external-dns) |  | [2.10.2]() | 
[weaveworks/flagger](https://github.com/weaveworks/flagger) |  | [1.3.0]() | 
[jenkins-x/dex](https://github.com/jenkins-x/dex) |  | [2.13.17]() | 
[jenkins-x-charts/environment-controller](https://github.com/jenkins-x-charts/environment-controller) |  | [0.0.508](https://github.com/jenkins-x-charts/environment-controller/releases/tag/v0.0.508) | 
[jenkins-x/exposecontroller-service](https://github.com/jenkins-x/exposecontroller-service) |  | [1.0.7]() | 
[jenkins-x/exposecontroller](https://github.com/jenkins-x/exposecontroller) |  | [2.3.114](https://github.com/jenkins-x/exposecontroller/releases/tag/v2.3.114) | 
[jenkins-x/jenkins-x-platform](https://github.com/jenkins-x/jenkins-x-platform) |  | [2.0.1599](https://github.com/jenkins-x/jenkins-x-platform/releases/tag/v2.0.1599) | 
[jenkins-x-charts/jx-build-templates](https://github.com/jenkins-x-charts/jx-build-templates) |  | [0.0.1194]() | 
...
[jenkins-x-charts/prow](https://github.com/jenkins-x-charts/prow) |  | [0.0.1470](https://github.com/jenkins-x-charts/prow/releases/tag/v0.0.1470) | 
[jenkins-x/sso-operator](https://github.com/jenkins-x/sso-operator) |  | [1.2.33]() | 
[jenkins-x-charts/tekton](https://github.com/jenkins-x-charts/tekton) |  | [0.0.47]() | 
...
[grafana/grafana](https://github.com/grafana/grafana) |  | [4.0.2](https://github.com/grafana/grafana/releases/tag/v4.0.2) | 
[prometheus/alertmanager](https://github.com/prometheus/alertmanager) |  | [9.3.1]() | 
[weaveworks/flagger](https://github.com/weaveworks/flagger):flagger |  | [0.20.3](https://github.com/weaveworks/flagger/releases/tag/0.20.3) | 
...
[jenkins-x/jenkins-x-builders-ml](https://github.com/jenkins-x/jenkins-x-builders-ml.git) |  | [0.1.915](https://github.com/jenkins-x/jenkins-x-builders-ml/releases/tag/v0.1.915) | 
...
[cloudbees/jx-tenant-service](https://github.com/cloudbees/jx-tenant-service) | [github.com/cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config) | [--files]() | **0.0.210**: [github.com/cloudbees/arcalos-boot-config](https://github.com/cloudbees/arcalos-boot-config)
...
[cloudbees/jx-repository-controller](https://github.com/cloudbees/jx-repository-controller) |  | []() | 
